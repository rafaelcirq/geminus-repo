...
class UsuarioController extends Controller
{
    ...
    function valida(Request $request){
        ...
        $this->validate($request, [
            'CPF' => 'required|numeric|digits:11|cpf|'.Rule::unique('usuario')->ignore($request['id']),
            ...
            'CPF.unique' => 'O CPF inserido já está em uso'
        ]);
    }

    function validation(Request $request){
        $this->validate($request, [
            'CPF' => 'required|numeric|digits:11|cpf|unique:usuario',
